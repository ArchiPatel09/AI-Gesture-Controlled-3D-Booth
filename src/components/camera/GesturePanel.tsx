...
import { Hand, X, ChevronDown, ChevronUp, Wifi, WifiOff, Loader } from "lucide-react";
import WebcamView from "./WebcamView";
import { GestureType } from "@/types";

// Metadata for each gesture type — used in both the status display and guide
...
export default function GesturePanel({
  ...
  // Controls whether the panel is expanded or collapsed to just a button
    ...
    return (
      ...
      >
        ...
        <div style={{ textAlign: "left" }}>
          ...
          {!isActive && (
            <p style={{ fontFamily: "var(--font-mono)", fontSize: "10px", color: "var(--text-muted)", lineHeight: 1, marginTop: "2px" }}>
              Click to enable
            </p>
          )}
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "14px", display: "flex", flexDirection: "column", gap: "12px" }}>
        ...
        {/* ── Current gesture display (when active) ────────────────── */}
        {isActive && !error && (
          <div
            style={{
